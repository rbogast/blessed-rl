...
class GlyphConfig:
    ...
    def get_terrain_glyph(self, terrain_type: str, visible: bool = True, lit: bool = True, penumbra: bool = False) -> Tuple[str, str]:
        """
        ...
        Args:
            ...
            penumbra: Whether the terrain is in penumbra (only matters if visible and not lit)
